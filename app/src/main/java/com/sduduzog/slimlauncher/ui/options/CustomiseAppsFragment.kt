...
class CustomiseAppsFragment : BaseFragment(), OnShitDoneToAppsListener {
    ...
    override fun getFragmentView(): ViewGroup = CustomiseAppsFragmentBinding.bind(requireView()).customiseAppsFragment
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        customiseAppsFragment.customiseAppsFragmentAdd.setOnClickListener(Navigation.createNavigateOnClickListener(R.id.action_customiseAppsFragment_to_addAppFragment))
    }
